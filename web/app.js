...
document.onreadystatechange = async () => {
  ...
  // Vue verbose mode for debugging
  ...
  app.vue = vue = new Vue({
    ...
    methods: {
      ...
      /**
       * Get location ID by produktor Geo ID
       *
       * @param {int} produktorGeoId
       * @param {function} onResult
       */
      getLocationIdByproduktorGeoId(produktorGeoId, onResult) {
        let result;

        app.net.request(`api.php?act=locationidbyproduktorgeoid&stage=${this.stage}&id=${produktorGeoId}`, fetcher => {
          fetcher.then(response => {
      ...
      copyVersionsToClipboard() {
        ...
        app.html.copyToClipboard(document.getElementById("versionBlock"))
  ...
  // Map after loading adding sources
  map.on('load', () => {
